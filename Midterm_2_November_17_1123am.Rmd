...
Plots to verify assumptions: Residuals vs. Predicted (predicted responce variable by the model) Residuals vs. (Observed
Values of the Independent Variable, used to produce model) Studentized Residuals vs. (Observed Values of the Independent
Variable) (OBS) Residual by QQ plot
...
#likewise 2rows 2 columns but we then need to call 4 separate plots 
par(mfrow = c(2, 2))

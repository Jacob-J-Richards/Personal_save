...
odds ratio confidence interval at alpha = 0.01 contains zero —\> cannot say that odds ratio does not equal zero —\> fail to reject null that variables are independent.
...
| **Table of treatment by heart_attack** |
|:--------------------------------------:|
|             **treatment**              |
|                 **NO**                 |
|               **asprin**               |

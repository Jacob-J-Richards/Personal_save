...
Relative Risk (Column 1)	1.6000	0.5725	4.4719
Relative Risk (Column 2)	0.6400	0.2526	1.6216
```
...
Relative Risk (Column 1)	1.6917	0.9171	3.1206
Relative Risk (Column 2)	0.6157	0.3565	1.0636
```
...
Relative Risk (Column 1)	Mantel-Haenszel	1.0455	1.0202	1.0713
 	Logit	1.0455	1.0202	1.0713
Relative Risk (Column 2)	Mantel-Haenszel	0.6667	0.5237	0.8487
...
Relative Risk (Column 1)	Mantel-Haenszel	1.0191	0.9979	1.0407
 	Logit	1.0191	0.9979	1.0407
Relative Risk (Column 2)	Mantel-Haenszel	0.7879	0.5974	1.0391
...
Relative Risk (Column 1)	Mantel-Haenszel	1.9775	1.3474	2.9021
 	Logit	1.9822	1.3508	2.9087
Relative Risk (Column 2)	Mantel-Haenszel	0.8891	0.8283	0.9544
...
```{r}
setwd(fil="~/Desktop/Personal_save/Stat_405_Final_Exam")
...
summary(smoke_lm2)
slope_intercept <- coefficients(smoke_lm2)
plot(mortality ~ smoking, data=smoke)
abline(a=slope_intercept[1],b=slope_intercept[2])
